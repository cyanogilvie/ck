    ...
    char **argv;			/* Argument strings. */
{
	...
	char* thingstring;
        ...
        switch (thing) {
	    case TOP_ARROW:     thingstring = "arrow1";      break;
	    case TOP_GAP:       thingstring = "trough1";     break;
	    case SLIDER:        thingstring = "slider";      break;
	    case BOTTOM_GAP:    thingstring = "trough2";     break;
	    case BOTTOM_ARROW:  thingstring = "arrow2";      break;
        }
	Tcl_SetObjResult(interp, Tcl_NewStringObj(thingstring, -1));
